    ...
    implements TextWatcher, LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    public void onCreate(Bundle icicle) {
        ...
        try {
            ...
            Log.e("ChooseContactActivity", "onCreate() invalid permissions to retrieve contacts\n" + e.toString());
        }

        textViewFilter = (TextView) findViewById(R.id.search_filter);
        if (textViewFilter != null) {
            textViewFilter.addTextChangedListener(this);
        }
    }
    ...
    public void afterTextChanged(Editable s) {
        //String filterStr = textViewFilter.getText().toString();
        //cursorAdapter.changeCursor(createCursor(filterStr));
        Bundle args = new Bundle();
        args.putString("filter", textViewFilter.getText().toString());
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        Log.v("ChooseContactActivity", "onLoadFinished() " + data.getCount() + " contacts");
